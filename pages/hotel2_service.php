    ...
    if(isset($_POST["current_status"])) 
        {
            ...
            if($update1)
                {
                    header("location:hotel2_service.php?page_id=2 && msg=Status Updated Sucessfully "); 
                } 
        }
...
<head>
    ...
    <title>Servicing Page Hotel 2</title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Servicing Hotel 2</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
...
?>
                                                ...
                                                <td>
                                                    <form role="form" method="post" action="hotel2_service.php?page_id=2">
