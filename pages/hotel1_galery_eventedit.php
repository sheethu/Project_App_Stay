        ...
        if (isset($_POST["events"]) && isset($_POST["description"])) 
            {
                ...
                if($update1)
                    {
                       header("location:hotel1_galery_event.php?page_id=1&&msg=Edit Successfully");
                    }
            }    
    ...
    <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Hotel1 events</h1>
                    </div>
                    <form action="hotel1_galery_eventedit.php?page_id=1&&msg=Update_sucessfully" method="post" class="col-sm-4" enctype="multipart/form-data">
