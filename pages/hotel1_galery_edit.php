    ...
    if(empty($_POST)===false)
        {
            ...
            if($update1)
                {
                    header('location:hotel1_galery.php?page_id=1 && msg=Edited Successfully');
                }
        }
?>
<!DOCTYPE html>
    ...
    <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Hotel1 offers</h1>
                    </div>
                    <form action="hotel1_galery_edit.php" method="post" class="col-sm-4">
